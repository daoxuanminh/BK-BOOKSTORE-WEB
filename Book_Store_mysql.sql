...
/*Bảng sách*/
CREATE TABLE Book(
book_id  int AUTO_INCREMENT, primary key(book_id) , /*Khóa chính book_id*/
...
insert into Book(book_name,price,publication_date,quantity,publisher_name,author_name,image,category,description) values 
('The Heart of the Deal','157000','2022/6/7',100,'Alcove Press','Lindsay MacMillan','1.jpg','Romance','Perfect for fans of Emily Giffin and Jojo Moyes, Lindsay MacMillan''s debut novel deftly captures the feeling of being adrift in your late twenties, with poignant commentary on female friendships, mental health, and what happiness really looks like.
...
('Jujutsu Kaisen, Vol. 8: Volume 8','92000','2022/2/2',100,'Viz Media','Gege Akutami','5.jpg','Manga','To gain the power he needs to save his friend from a cursed spirit, Yuji Itadori swallows a piece of a demon, only to find himself caught in the midst of a horrific war of the supernatural!
...
insert into Customer(account,password,name,sex,dob,email,phone_number,address) values
('anhnon','1234','Nguyen Ngoc Anh','male','2000/5/6','abc@gmail.com','098234232','Hai Ba Trung, Ha Noi'),
('anhga','1234','Ha Buu Dinh','male','2002/12/26','habuudinh@gmail.com','0917973399','Thanh Xuan, Ha Noi');
