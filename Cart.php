...
<div>
    ...
    <div class="sum">
        ...
        <div class="top gia">2000000VND<br></div>
        <div class="top"><button><strong> Thanh Toán</strong></button></div>
    </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-4 img">
                                <div class="image-wrapper">
                                    ...
                                    <?php
                                    // echo $row['book_id'];
                                    echo "<img class='img' src='img/" . $row['image'] . "' alt='img'>";
                                    ?>
                                </div>
                            </div>
                                ...
                                <div class="card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-md-auto">
                                            <p class="price-1"><?php echo $row['price'].".VND" ?></p>
